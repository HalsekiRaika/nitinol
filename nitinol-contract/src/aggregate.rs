...
/// commands are decided by the pure, synchronous [`Decider`](crate::Decider)
/// contract defined in this crate, and the events of the resulting
/// [`Decision`](crate::Decision) are applied here to advance the state.
///
